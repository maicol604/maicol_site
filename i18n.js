...
const translations = {
  en: {
    ...
    exp_company_1: 'Etra I+D',
    exp_desc_1: "Leading research and development across the entire technology stack for world-class European traffic and mobility projects. Architecting scalable systems that process real-time data at continental scale — from desktop analytics platforms and web scraping pipelines to mobile applications and responsive web dashboards used by traffic operators across Europe.",
    exp_role_2: 'Senior Frontend Developer — Angular',
    exp_period_2: '2024 — 2025',
    exp_company_2: 'Domain Logic · Madrid',
    exp_desc_2: 'Built mission-critical frontend systems for national security projects serving the Spanish National Police. Developed high-performance Angular applications handling sensitive data with strict security and compliance requirements. Delivered robust, accessible interfaces used by law enforcement officers in real-time operations across Spain.',
    exp_role_3: 'Senior Frontend Developer',
    exp_period_3: '2022 — 2024',
    exp_company_3: 'Overgroup',
    exp_desc_3: 'Led frontend development for enterprise web applications using React and modern JavaScript. Implemented responsive UI components, optimized performance, and collaborated with design teams to deliver pixel-perfect interfaces.',
    exp_role_4: 'Software Engineer — GIS & Traffic',
    exp_period_4: '2021 — 2022',
    exp_company_4: 'European Infrastructure Projects',
    exp_desc_4: 'Developed geospatial processing pipelines and real-time traffic visualization systems for European infrastructure projects. Built map-based dashboards integrating GIS data with live traffic feeds, spatial analytics, and predictive routing algorithms.',
    exp_role_5: 'Backend Developer',
    exp_period_5: '2020 — 2021',
    exp_company_5: 'Freelance & Remote',
    exp_desc_5: 'Delivered end-to-end web applications for clients across Europe and the Americas. Specialized in RESTful API design, database modeling, server architecture, and WordPress custom integrations.',
    exp_role_6: 'UI/UX Designer & Frontend Developer',
    exp_period_6: '2019 — 2020',
    exp_company_6: '4to Ángulo & Motivarnos',
    exp_desc_6: 'Designed and developed responsive web platforms from concept to deployment. Created UI/UX wireframes and prototypes, then built performant frontend architectures with React and modern CSS.',
    exp_role_7: 'Junior Frontend Developer',
    exp_period_7: '2017 — 2019',
    exp_company_7: 'Nelumbo Consultores',
    exp_desc_7: 'Built responsive websites and landing pages for diverse clients. Gained solid foundations in HTML, CSS, JavaScript, and WordPress theme development while collaborating in agile teams.',
    exp_role_8: 'Junior WordPress Developer',
    exp_period_8: '2016 — 2017',
    exp_company_8: 'Development Agency',
    exp_desc_8: 'Developed custom WordPress themes and plugins. Implemented responsive designs, optimized site performance, and integrated third-party APIs for enhanced functionality.',
  ...
  es: {
    ...
    exp_company_1: 'Etra I+D',
    exp_desc_1: 'Lidero investigación y desarrollo en todo el stack tecnológico para proyectos europeos de tráfico y movilidad de categoría mundial. Diseño arquitecturas escalables que procesan datos en tiempo real a escala continental — desde plataformas de análisis de escritorio y pipelines de web scraping hasta aplicaciones móviles y dashboards web responsivos usados por operadores de tráfico en toda Europa.',
    exp_role_2: 'Senior Frontend Developer — Angular',
    exp_period_2: '2024 — 2025',
    exp_company_2: 'Domain Logic · Madrid',
    exp_desc_2: 'Construí sistemas frontend críticos para proyectos de seguridad nacional que sirven a la Policía Nacional Española. Desarrollé aplicaciones Angular de alto rendimiento manejando datos sensibles con estrictos requisitos de seguridad y cumplimiento. Entregué interfaces robustas y accesibles usadas por agentes de seguridad en operaciones en tiempo real en toda España.',
    exp_role_3: 'Senior Frontend Developer',
    exp_period_3: '2022 — 2024',
    exp_company_3: 'Overgroup',
    exp_desc_3: 'Lideré el desarrollo frontend para aplicaciones web empresariales usando React y JavaScript moderno. Implementé componentes UI responsivos, optimicé el rendimiento y colaboré con equipos de diseño para entregar interfaces pixel-perfect.',
    exp_role_4: 'Ingeniero de Software — GIS y Tráfico',
    exp_period_4: '2021 — 2022',
    exp_company_4: 'Proyectos de Infraestructura Europea',
    exp_desc_4: 'Desarrollé pipelines de procesamiento geoespacial y sistemas de visualización de tráfico en tiempo real para proyectos de infraestructura europeos. Construí dashboards basados en mapas integrando datos GIS con feeds de tráfico en vivo, análisis espacial y algoritmos de enrutamiento predictivo.',
    exp_role_5: 'Desarrollador Backend',
    exp_period_5: '2020 — 2021',
    exp_company_5: 'Freelance y Remoto',
    exp_desc_5: 'Entregué aplicaciones web end-to-end para clientes en Europa y América. Especializado en diseño de APIs RESTful, modelado de bases de datos, arquitectura de servidores e integraciones personalizadas de WordPress.',
    exp_role_6: 'UI/UX Designer & Frontend Developer',
    exp_period_6: '2019 — 2020',
    exp_company_6: '4to Ángulo & Motivarnos',
    exp_desc_6: 'Diseñé y desarrollé plataformas web responsivas desde el concepto hasta el despliegue. Creé wireframes y prototipos UI/UX, luego construí arquitecturas frontend de alto rendimiento con React y CSS moderno.',
    exp_role_7: 'Junior Frontend Developer',
    exp_period_7: '2017 — 2019',
    exp_company_7: 'Nelumbo Consultores',
    exp_desc_7: 'Construí sitios web responsivos y landing pages para diversos clientes. Adquirí bases sólidas en HTML, CSS, JavaScript y desarrollo de temas WordPress mientras colaboraba en equipos ágiles.',
    exp_role_8: 'Junior WordPress Developer',
    exp_period_8: '2016 — 2017',
    exp_company_8: 'Agencia de Desarrollo',
    exp_desc_8: 'Desarrollé temas y plugins personalizados de WordPress. Implementé diseños responsivos, optimicé el rendimiento de sitios e integré APIs de terceros para funcionalidades mejoradas.',
